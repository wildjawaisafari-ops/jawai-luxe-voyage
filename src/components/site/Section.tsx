  ...
  return (
    <header className="relative pt-32 pb-20 sm:pt-40 sm:pb-28 overflow-hidden">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 text-center">
        ...
        <h1 className="mt-6 font-display text-5xl sm:text-6xl lg:text-7xl leading-[1.02] animate-fade-up delay-1">
          {title}
        </h1>
        {subtitle && (
          <p className="mt-6 text-base sm:text-lg text-muted-foreground max-w-2xl mx-auto animate-fade-up delay-2">
            {subtitle}
          </p>
        )}
      </div>
